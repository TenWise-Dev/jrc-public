...
pmid_file = os.path.join(BASE_DIR, 'tests/data/input_new_pmids.txt')
records_file = os.path.join(BASE_DIR, 'tests/data/test_new_records.txt')
output_file = os.path.join(BASE_DIR, 'tests/data/test_new_pmids.json')
example_file = os.path.join(BASE_DIR, 'tests/data/example_new_pmids.json')
example_records_file = os.path.join(BASE_DIR, 'tests/data/example_new_records.txt')
entrez_email = 'some@hotmail.nl'

# Make test for the function
def test_newpmid():
    from lib.NewPMID import get_records, parse_records, medline_to_json
